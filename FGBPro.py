...
def generate_video(script):
    ...
    payload = {
        ...
        "source_url": "https://create-images-results.d-id.com/auth0%7C6602fd8cf86a5e615f8af224/drm_EELOu_7s2MVpDSjyAXAdW/image.png"
    }
    ...
    return video_url 
    avatarlist = {
        "Male": "https://create-images-results.d-id.com/auth0%7C6602fd8cf86a5e615f8af224/drm_EELOu_7s2MVpDSjyAXAdW/image.png",
        "Female": "https://create-images-results.d-id.com/auth0%7C6602fd8cf86a5e615f8af224/drm_EELOu_7s2MVpDSjyAXAdW/image.png"
    }
...
def main():
    ...
    video_path = "https://photosfordidd.s3.eu-central-1.amazonaws.com/Jameel.mp4"   
    image2_path = "https://photosfordidd.s3.eu-central-1.amazonaws.com/Screenshot+2024-05-02+203737.png"
    image3_path = "https://photosfordidd.s3.eu-central-1.amazonaws.com/1.png"
    image4_path = "https://photosfordidd.s3.eu-central-1.amazonaws.com/Screenshot+2024-05-02+204753.png"
    image5_path = "https://photosfordidd.s3.eu-central-1.amazonaws.com/3.png"
    image6_path = "https://photosfordidd.s3.eu-central-1.amazonaws.com/Screenshot+2024-05-02+204949.png"
    image7_path = "https://photosfordidd.s3.eu-central-1.amazonaws.com/2.png"
    image8_path = "https://photosfordidd.s3.eu-central-1.amazonaws.com/4.png"
    
    st.set_page_config(
        page_title="First Global Bank InvestPro",
        page_icon="📚",
        layout="wide"
    ) 
    ...
    image_path = "https://photosfordidd.s3.eu-central-1.amazonaws.com/Screenshot+2024-05-02+203737.png"
    st.image(image_path, caption='Dont Worry - Let Me Show You')    
    st.image(image3_path, caption='')
    st.image(image4_path, caption='')
    st.image(image5_path, caption='')
    st.image(image6_path, caption='')
    st.image(image7_path, caption='')
    st.image(image8_path, caption='')
    ...
    add_selectbox = st.sidebar.selectbox(
        'How much would you like me to invest every month for you?',
        ('Nothing thank you', '$50','$100','$500','I want to choose custom amount')
    )
    add_selectbox = st.sidebar.selectbox(
        'How would you like to keep you up to date on your portfolio performance?',
        ('Email', 'WhatsApp', 'Phone')
    )  
    slider_value = st.sidebar.slider("On a scale of 1 to 10 how risky are you willing to invest?", 1, 5, 10)
    ...
    if st.session_state.start_chat:
        ...
        if prompt := st.sidebar.chat_input("Hello how can I help?"):
            ...
            print(f"MESSAGES: {st.session_state.messages}")                                                                
            video_url = generate_video(processed_response[:550])            
